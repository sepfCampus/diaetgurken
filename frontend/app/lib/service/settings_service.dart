...
class SettingsService implements SettingsBaseService
{
  ...
  EntityVoConverterBaseUtil<SettingsEntity> _entityVoConverterUtil;
  ...
  Future<Settings> getSettings(int userId) async
  {
    ...
    return this._entityVoConverterUtil.convertEntityToVo(settingsEntity);
  }

  @override
  void updateSettings(int userId, Settings settings) async
  {
    this._settingsDao.updateSettings(this._entityVoConverterUtil.convertVoToEntity(userId, settings));
  }
}
